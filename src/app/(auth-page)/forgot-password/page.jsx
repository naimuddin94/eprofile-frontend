          ...
          <div className='w-[90%] mx-auto'>
            ...
            <Card className="pb-10">
              <CardHeader className='text-center'>
                ...
                <CardDescription className='text-xl'>Enter your registered email </CardDescription>
              </CardHeader>
              <CardContent>
                {/* <form> */}
                  <div className="grid w-full items-center gap-4">
                    ...
                    <Button onClick={() => route.push('/reset-password')} className='h-12 hover:bg-[#FF6702]/40'>Continue</Button>
                  </div>
                {/* </form> */}
              </CardContent>
