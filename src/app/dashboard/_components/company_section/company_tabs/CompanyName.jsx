  ...
  return (
    <div>
      ...
      <div className="relative">
        ...
        <div
          onClick={handlePersonImgClk}
          className="bg-slate-300 md:w-[170px] w-[120px] md:h-[170px] h-[120px] rounded-full absolute md:-bottom-[4.8rem] -bottom-[3rem] md:left-1/2 md:-translate-x-1/2 left-5"
        >
          <input
            type="file"
            name="photo"
        ...
        <div
          onClick={handleImgClk}
          className="absolute lg:bottom-2  right-2 bottom-2"
        >
          <input
            type="file"
            name="coverPhoto"
      ...
      <div className="mb-10 mt-20 ">
        <div className="space-y-4 mb-10">
          ...
          <ProfileInput
            ...
            isStar={true}
            style={"profileInput h-12"}
            change={(e) => setData({ ...data, username: e.target.value })}
          />
        </div>
