...
const Name = memo(function Name({ setValue, setProfile, profile, userId, profileData, updateProfile, loading }) {
                ...
                <div>
                    ...
                    <div className='mb-10 mt-20  '>
                        ...
                        <div className='mt-10 flex justify-end' >
                            <CustomBtn style={'w-[150px]'} title={loading ? <LoadingSVG /> : profileData ? 'Update & Next' : 'Save & Next'} click={handleUpdate} />
                        </div>
                    </div>
                </div>
            }
