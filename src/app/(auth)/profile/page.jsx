...
export default function Profile() {
    return (
        <section className='w-[calc(100%_-_300px)]'>
                ...
                <Card className="w-[320px]">
                    ...
                    <CardContent className='flex flex-col justify-center items-center'>
                        ...
                        <div className='flex justify-between gap-3'>
                            <div>
                                <Button className='w-min h-min p-1 hover:bg-[#FF6702]/40'>Last 30 days</Button>
                                <p className='text-center'>0</p>
                            </div>
                            <div>
                                <Button className='w-min h-min p-1 hover:bg-[#FF6702]/40'>Last 7 days</Button>
                                <p className='text-center'>0</p>
                            </div>
                            <div>
                                <Button className='w-min h-min p-1 hover:bg-[#FF6702]/40'>Today</Button>
                                <p className='text-center'>0</p>
                            </div>
                        </div>
                    </CardContent>
